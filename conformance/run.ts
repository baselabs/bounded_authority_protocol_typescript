...
// drifting silently. This MUST match the Python runner's hex SHA (f3054cbb...5f2 → base64url).
const CERTIFIED_INDEX_SHA = "8wVMuzfE1AsUjZihGLOumshi4AsAdvfyXA9sey_2dfI";
