...
// (sdks/typescript/src/v1.ts), and asserts agreement on all 279 cases. Asserts the index.json
...
// drifting silently. This MUST match the Python runner's hex SHA (5f221f41...a17bed → base64url).
const CERTIFIED_INDEX_SHA = "XyIfQUIYPC_R0Z0fGo7n8GRSMrM_taKlLV_2lA2he-0";
